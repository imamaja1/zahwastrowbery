...
export default function Profile({ profile }: Props) {
    ...
    return (
        <CustomerLayout title="Profil Saya">
            <Head title="Profil Saya - ZahwaStrowbery" />
            ...
            {/* HALAMAN PROFIL */}
            <div className="flex flex-col w-full px-4 py-4 md:py-6 pb-24 gap-5 max-w-md mx-auto">
                {/* Header Back & Title */}
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="font-extrabold text-lg text-[#1b1b1e] leading-tight">Profil Pengguna</h1>
                            <p className="text-[11px] text-zinc-500">Kelola akun dan info kontak Anda</p>
                        </div>
                    </div>
                ...
                <Card className="rounded-3xl border-[#eae7eb] shadow-xs bg-gradient-to-br from-white via-[#fdfbfe] to-rose-50/30 overflow-hidden relative">
                    <div className="p-5 flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
                        ...
                        <div className="flex-1 flex flex-col items-center sm:items-start min-w-0">
                            <div className="flex items-center gap-1.5 flex-wrap justify-center sm:justify-start">
                                ...
                                {profile.role === 'admin' ? (
                                    <Badge className="bg-amber-600 hover:bg-amber-600 text-[10px] font-extrabold px-2 py-0">
                                        Admin Toko
                                    </Badge>
                                ) : (
                            ...
                            <span className="text-xs text-zinc-600 mt-0.5 truncate block max-w-full">
                                {profile.email}
                            </span>
                            {profile.phone ? (
                    ...
                    {profile.role === 'admin' && (
                        <div className="bg-amber-500/10 border-t border-amber-200/60 px-5 py-2.5 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <span className="material-symbols-outlined text-amber-700 text-[18px]">
                                    admin_panel_settings
                                </span>
                                <span className="text-[11px] font-bold text-amber-900">
                                    Akses Backoffice Toko
                                </span>
                            </div>
                            <Button
                                asChild
                                size="sm"
                                className="h-7 text-[10px] font-bold bg-amber-600 hover:bg-amber-700 text-white rounded-lg shadow-2xs"
                            >
                                <Link href="/admin/dashboard">Buka Dashboard</Link>
                            </Button>
                        </div>
                    )}
                </Card>
                ...
                {activeTab === 'info' && (
                    <Card className="rounded-3xl border-[#eae7eb] shadow-xs p-5">
                        <CardHeader className="p-0 pb-4">
                            <CardTitle className="text-sm font-bold text-zinc-900">Perbarui Informasi Kontak</CardTitle>
                            <CardDescription className="text-xs text-zinc-500">
                                Pastikan data nomor WhatsApp aktif untuk kemudahan pengiriman buah
                            </CardDescription>
                        </CardHeader>
                        ...
                        <form onSubmit={handleSubmitProfile} className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-1.5">
                                <div className="flex items-center justify-between">
                                    <Label htmlFor="phone" className="text-xs font-bold">No. WhatsApp / HP</Label>
                ...
                {activeTab === 'security' && (
                    <Card className="rounded-3xl border-[#eae7eb] shadow-xs p-5">
                        <CardHeader className="p-0 pb-4">
                            <CardTitle className="text-sm font-bold text-zinc-900">Keamanan & Sandi</CardTitle>
                            <CardDescription className="text-xs text-zinc-500">
                                Ubah kata sandi akun untuk menjaga keamanan akun Anda
                            </CardDescription>
                        </CardHeader>

                        {/* Google Auth Status */}
                        {profile.has_google && (
                            <div className="mb-4 p-3 rounded-2xl bg-blue-50/60 border border-blue-200/80 flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xs font-bold text-blue-900 block">Akun Google Terhubung</span>
                                    <span className="text-[10px] text-blue-700">Anda dapat masuk secara instan dengan Google</span>
                                </div>
                            </div>
                        )}
